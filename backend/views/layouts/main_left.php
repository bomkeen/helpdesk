        ...
        <div class="rows">
            <div class="col-md-2">
              ...
              echo SideNav::widget([
                  ...
                  'heading' => 'Menu',
                  'items' => [
                      ['label' => 'หน้าหลัก', 'icon' => 'home', 'url' =>'../../frontend/web/index.php'],
                      ['label' => 'ผู้ใช้งาน', 'icon' => 'user', 'url' =>Url::to(['/helpdeskuser/index'])],
                      ['label' => 'เจ้าหน้าที่', 'icon' => 'user', 'url' =>Url::to(['/staff/index'])],
                      ['label' => 'ประเภท', 'icon' => 'tags', 'url' =>Url::to(['/helpdesktype/index'])],
                      ['label' => 'แผนก', 'icon' => 'inbox', 'url' =>Url::to(['/department/index'])],
                      ['label' => 'Line Token', 'icon' => 'tower', 'url' =>Url::to(['/line_token/update','id'=>1])],
                      ['label' => 'ออกจากระบบ', 'icon' => 'off', 'url' =>Url::to(['/site/logout']),['data-method' => 'post']],
                  ],
              ]);
